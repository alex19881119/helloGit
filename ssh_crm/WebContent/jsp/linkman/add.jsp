					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								<td>所属客户：</td>
								<td colspan="3">
								<input type="hidden" name="customer.cust_id" style="WIDTH: 180px" id="cust_id" value="${linkman.customer.cust_id }"/>
								<input type="hidden" name="lkm_id" value="${linkman.lkm_id}"/>
								<input type="text"  style="WIDTH: 180px" id="cust_name" value="${linkman.customer.cust_name }"/>
