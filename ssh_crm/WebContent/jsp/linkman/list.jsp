										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>联系人名称：</TD>
													<TD>
													<INPUT class=textbox id=sChannel2 value="${param.lkm_name}"
													...
													<INPUT class=textbox id="cust_name" name="cust_name"
														style="WIDTH: 80px" maxLength=50 value="${param['cust_name']}">
